    ...
    <section className="py-16 md:py-24 px-4 sm:px-6 bg-white">
      <div className="max-w-screen-xl mx-auto">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12 lg:gap-16 items-center">
          ...
          <div>
            <AnimatedSection direction="right" delay={0.1} duration={0.8}>
              ...
              <InteractiveButton
                ...
                intensity="strong"
                variant="primary"
                className="group inline-flex items-center justify-center gap-2 bg-gradient-to-r from-blue-700 to-blue-500 text-white font-semibold text-lg px-8 py-4 rounded-lg shadow-lg hover:shadow-xl transform hover:-translate-y-0.5 focus:ring-4 focus:ring-blue-300"
              >
          ...
          <div>
            <AnimatedSection direction="left" delay={0.2} duration={0.8}>

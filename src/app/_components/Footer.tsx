 ...
 * It renders a Next.js Link for internal navigation.
 */
const FooterLink: React.FC<{ href: string; icon: React.ReactNode; children: React.ReactNode }> = ({ href, icon, children }) => {
  return (
    <Link
      href={href}
            ...
            <div className="grid grid-cols-1 gap-8 sm:grid-cols-2">
              ...
              <section>
                ...
                <div className="flex flex-col space-y-4">
                  <FooterLink href="/" icon={<Home size={18} />}>Home</FooterLink>
                  <FooterLink href="/about-us" icon={<Info size={18} />}>About Us</FooterLink>
                  <FooterLink href="/login" icon={<LogIn size={18} />}>Login</FooterLink>
                  <FooterLink href="/faq" icon={<HelpCircle size={18} />}>FAQ</FooterLink>
                  <FooterLink href="/blog" icon={<Newspaper size={18} />}>Blog & Resources</FooterLink>
                  <FooterLink href="/technology" icon={<Cpu size={18} />}>Technology Stack</FooterLink>
                  <FooterLink href="/pricing" icon={<DollarSign size={18} />}>Pricing</FooterLink>
                </div>
              </section>
              ...
              <section>
                ...
                <div className="flex flex-col space-y-4">
                  ...
                  <FooterLink href="/privacy-policy" icon={<Shield size={18} />}>
                    Privacy Policy
                  </FooterLink>
                  <FooterLink href="/terms-of-service" icon={<Shield size={18} />}>
                    Terms of Service
                  </FooterLink>
                </div>
              </section>
